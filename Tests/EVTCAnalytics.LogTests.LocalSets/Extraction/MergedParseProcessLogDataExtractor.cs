...
/// <summary>
/// A log data extractor that uses the merged parse and process steps with default settings.
/// Parse & Process -> Analyze
/// </summary>
public class MergedParseProcessLogDataExtractor : ILogDataExtractor
{
