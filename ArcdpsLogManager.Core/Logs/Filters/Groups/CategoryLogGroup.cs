...
namespace GW2Scratch.ArcdpsLogManager.Logs.Filters.Groups
{
	...
	public class CategoryLogGroup : LogGroup
	{
		private static readonly Dictionary<EncounterCategory, string> CategoryNames = new Dictionary<EncounterCategory, string>
		{
			...
			{EncounterCategory.RaidEncounterIcebroodSaga, "Icebrood Saga"},
			{EncounterCategory.RaidEncounterEndOfDragons, "End of Dragons"},
			{EncounterCategory.RaidEncounterSecretsOfTheObscure, "Secrets of the Obscure"},
			{EncounterCategory.RaidEncounterVisionsOfEternity, "Visions of Eternity"},
			{EncounterCategory.RaidEncounterFestival, "Festivals"},
