...
namespace GW2Scratch.EVTCAnalytics.Events
{
	...
	public class AgentTransformationEvent(long time, Agent agent, uint id) : AgentEvent(time, agent)
	{
	...
	/// </summary>
	public class AgentTransformationRemoveEvent(long time, Agent agent, uint id) : AgentEvent(time, agent)
	{
		public uint TransformationID { get; } = id;
	}
}